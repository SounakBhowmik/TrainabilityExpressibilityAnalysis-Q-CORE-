...
\author{\IEEEauthorblockN{Sounak Bhowmik}
...
the optimization difficulty of a quantum machine-learning model.  In this paper, we study
this interaction with a crossed design comprising three feature maps, two
ansatz families, three circuit widths, four depths, and three connectivity
patterns. We calibrated the experiments in noisy and noiseless simulation, and ten random seeds.
...
\begin{figure*}[t]
  \centering
  \resultfigure{poster_tradeoff.png}{Noiseless gradient variance versus expressibility, faceted by ansatz and qubit count.}
